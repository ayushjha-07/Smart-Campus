          ...
          <div className="flex items-center gap-2.5">
            ...
            <div>
              ...
              <p className="text-xs text-[#9FB1BC]">
                Private log for {DEPARTMENT_STAFF_PROFILE.department} staff
              </p>
            </div>
          </div>
          <button
        ...
        <form onSubmit={handleSubmit} className="mt-4 space-y-4 text-xs">
          ...
          <div>
            ...
            <textarea
              ...
              placeholder="Add a private note for department staff..."
          ...
          <p className="text-[11px] text-[#9FB1BC]/80">
            Internal notes will not appear on student-facing updates or tracking pages.
          </p>
