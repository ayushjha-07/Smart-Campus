...
import { COMPLAINT_ACTIVITY_DATA } from '../../data/departmentMockData';
    ...
    return (
      <div className="bg-[#07121A] border border-[#315C3A] rounded-lg p-3 shadow-xl text-xs z-50">
        <div className="font-semibold text-[#F5F5F0] border-b border-[#1A2E3B] pb-1 mb-2 flex items-center justify-between gap-4">
          <span>{label}</span>
          <span className="text-[10px] text-[#9FB1BC]">Workload Flow</span>
        </div>
...
export default function ComplaintActivityChart() {
        ...
        <div>
          <div className="flex items-center gap-2">
            ...
            <span className="hidden sm:inline-flex items-center gap-1 px-2 py-0.5 rounded text-[10px] font-semibold bg-[#315C3A]/20 text-[#A7C481] border border-[#315C3A]/40">
              <Activity className="w-3 h-3 text-[#D4A84F]" /> Weekly Velocity
            </span>
          </div>
        ...
        <ResponsiveContainer width="100%" height="100%">
          ...
          >
            <defs>
              ...
              <linearGradient id="colorResolvedDept" x1="0" y1="0" x2="0" y2="1">
            ...
            <Legend
              ...
              align="right"
              iconType="circle"
              wrapperStyle={{ paddingBottom: '10px', fontSize: '11px', color: '#9FB1BC' }}
            />
            <Area
              type="monotone"
              dataKey="assigned"
