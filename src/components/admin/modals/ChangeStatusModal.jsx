...
import { STATUS_OPTIONS } from '../../../data/adminMockData';
...
export default function ChangeStatusModal({ isOpen, onClose, complaint, onUpdateStatus }) {
      ...
      <div className="relative w-full max-w-md bg-[#0D1B22] border border-[#1A2E3B] rounded-xl shadow-2xl p-6 overflow-hidden">
        ...
        <div className="flex items-center justify-between pb-4 border-b border-[#1A2E3B]">
          <div className="flex items-center gap-2.5">
            ...
            <div>
              <h3 className="text-base font-bold text-[#F5F5F0]">Change Status</h3>
